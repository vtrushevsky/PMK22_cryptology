...
//    file >> amountOfTriangles;
//    try {
//        if (amountOfTriangles <= 0)
//        {
//            throw my_exception("out of range.");
//        }
//    }
//    catch(my_exception)
//    {
//        cout << "Amount of triangles need to be greater than zero" << endl;
//    }
//    Triangle* tri = new Triangle[amountOfTriangles]();
//    for (int i = 0; i < amountOfTriangles; i++) 
//    {
//        file >> tri[i];
//        tri[i].calc_perim();
//        try {
//            if (tri[i].calc_perim() <= 0)
//                throw my_exception("Invalid arguments");
//        }
//        catch (my_exception)
//        {
//            cout << "Wrong arguments for triangle sides.."; 
//        }
//        triangles.insertFront(tri[i]);
//    }
//        
//    file.close();
//    
//    sortList(triangles,"sorted_triangles.txt");
//    sortByPerim(triangles,0, 52,"sorted_triangles_perim.txt");
//    return 0;
//}